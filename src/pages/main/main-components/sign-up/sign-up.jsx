...
const SignUp = () => {
  ...
  return (
    <div className={cn(style.container, isUserExists ? style.notValid : '')}>
      <div className={cn(style.form)}>
        ...
        <button onClick={() => dispatch(registration(form))}>Register</button>
      </div>
      <Link
        to="/main"
        onClick={() => dispatch(nullifyIsUserExists())}
      >
